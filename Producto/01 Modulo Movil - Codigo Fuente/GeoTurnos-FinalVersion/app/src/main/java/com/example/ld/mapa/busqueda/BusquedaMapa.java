...
public class BusquedaMapa extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(direccion.equals("")){
                    Toast.makeText(BusquedaMapa.this, "No hay dirección para buscar", Toast.LENGTH_SHORT).show();

                }else{
                    Toast.makeText(BusquedaMapa.this, "Buscando " +direccion+ " ", Toast.LENGTH_SHORT).show();
                    ...
                    try {
                        ...
                        Toast.makeText(BusquedaMapa.this, "No se ha encontrado la dirección: " +direccion, Toast.LENGTH_SHORT).show();
                    }
                }
                // Ocultar el teclado
